...
prompt_a = "Tell me about Python lists."  # <-- fill in the prompt here

# Level B: Structured Prompt (add a role + constraint)
# TODO: write a prompt with a role and a constraint
prompt_b = "You are a Python tutor for beginners. Explain Python lists in under 100 words without using technical jargon."  # <-- fill in the prompt here

# Level C: Precise Prompt (role + constraint + output format)
# TODO: write a prompt with a role, a constraint, and an output format
prompt_c = "You are a Python expert. List the 3 most common list operations in Python. Return ONLY a valid JSON array of objects, where each object has keys 'operation', 'syntax', and 'example'. Do not include markdown code block formatting or explanations."  # <-- fill in the prompt here
